...
const steps = [
  {
    ...
    text: "API & Webhooks",
    description:
      "Integrate our simple API and set up webhooks for real-time notifications.",
    icon: (
      <svg
  ...
  },
  {
    ...
    text: "BTC, ETH, USDT",
    description:
      "Start accepting popular cryptocurrencies from customers worldwide.",
    icon: (
      <svg
        className="w-6 h-6 text-emerald-600"
        fill="none"
  ...
  },
  {
    ...
    text: "Wallet or FIAT",
    description:
      "Receive funds in your crypto wallet or convert to your local currency.",
    icon: (
      <svg
        className="w-6 h-6 text-emerald-600"
        fill="none"
    ...
    <section className="bg-white py-20 px-6 md:px-12 lg:px-20 overflow-hidden">
      <div className="max-w-3xl mx-auto text-center mb-16">
        ...
        <p className="text-gray-600 text-lg">
          Simple. Fast. Crypto-ready in minutes.
        </p>
      </div>
