...
const features: Feature[] = [
    {
        ...
        description: "Enable crypto subscriptions with 3/7/1-day reminders and automatic renewal support.",
    },
    {
        icon: "ShieldCheck",
        title: "Buyer Protection",
        description: "Freeze payments for 7 days and mark checkout as secured. Optional per transaction.",
    },
    {
        icon: "Wallet",
        title: "Self-Hosted Wallets",
        description: "Get full control over your funds using your own withdrawal wallet infrastructure.",
    },
    {
        icon: "Zap",
        ...
        <section className="py-16 bg-gray-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold mb-4">What Bitmopay can do for you</h2>
                    ...
                    {features.map((feature, index) => (
                        <Card key={index} className="border-none shadow-sm">
                            <CardContent className="p-6">
                                <div
                                    className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-emerald-100 text-emerald-600 mb-4">
