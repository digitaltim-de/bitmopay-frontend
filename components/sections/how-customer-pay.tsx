  ...
  const steps = [
    {
      ...
      description:
        "Browse and select products from an online store that uses Bitmopay.",
      icon: (
        <svg
          width="24"
          height="24"
    ...
    },
    {
      ...
      title: "Checkout",
      description:
        "At checkout, select 'Pay with Cryptocurrency' as your payment method.",
      icon: (
        <svg
          width="24"
          height="24"
    ...
    },
    {
      ...
      description:
        "Scan the QR code or copy the wallet address to complete your payment.",
      icon: (
        <svg
          width="24"
          height="24"
            ...
            <div className="order-2 md:order-1">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-100">
                ...
                <p className="text-gray-600 mb-8">
                  Your customers will enjoy these advantages when paying with
                  cryptocurrency at your store:
                </p>
