...
export const partners: Partner[] = [
  {
    ...
    logo: "https://coingate.com/app/uploads/2023/11/Logo_Alternative-Airlines_grey.png",
  },
  {
    name: "Cherry Servers",
    logo: "https://coingate.com/app/uploads/2023/11/Logo_Cherry-servers_grey.png",
  },
...
export const features: Feature[] = [
  {
    ...
    icon: "Globe",
    modalTitle: "Global Payment Optimization",
    modalDescription:
      "Optimize your payment processes globally to increase conversion rates and improve customer experience.",
    ctaText: "Learn About Global Payments",
  },
  {
    ...
    icon: "Zap",
    modalTitle: "Continuous Revenue Growth",
    modalDescription:
      "Boost your business with seamless recurring payment solutions and advanced payment issue resolution.",
    ctaText: "Explore Revenue Solutions",
  },
  {
    ...
    icon: "Shield",
    modalTitle: "Chargeback Protection",
    modalDescription:
      "Get comprehensive protection against fraudulent transactions and chargebacks.",
