...
const caseStudies = [
  {
    ...
    industry: "Retail",
    description:
      "Learn how an online electronics retailer boosted conversion rates by accepting cryptocurrency payments.",
    image: "/placeholder.svg",
    link: "/resources/case-studies/e-store-xyz",
    results: [
      "22% increase in sales",
      "35% new customer acquisition",
  ...
  },
  {
    ...
    description:
      "See how a hotel booking website reduced transaction fees and attracted crypto-savvy travelers.",
    image: "/placeholder.svg",
  ...
  },
  {
    ...
    industry: "B2B SaaS",
    description:
      "How a B2B software company implemented crypto subscriptions and simplified their payment processing.",
    image: "/placeholder.svg",
  ...
  },
  {
    ...
    results: [
      "Global customer base expanded",
      "Reduced chargebacks to near-zero",
      ...
      <AnimatedSection containerClass="cases-grid" itemClass="case-card">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          {caseStudies.map((study, index) => (
            <Card
              key={index}
              className="case-card overflow-hidden border-t-4 border-t-emerald-500 transition-all hover:shadow-md"
            >
              ...
              <CardContent>
                <p className="mb-4 text-gray-500 dark:text-gray-400">{study.description}</p>
