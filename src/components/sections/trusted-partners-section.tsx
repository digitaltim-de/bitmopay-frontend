  ...
  return (
    <section className="py-1 relative overflow-hidden">
      ...
      <div className="relative w-full mt-12">
        ...
        <div className="absolute left-0 top-0 bottom-0 w-40 z-10 bg-gradient-to-r from-white via-white to-transparent"></div>

        {/* Right gradient mask - matches the background gradient */}
        <div className="absolute right-0 top-0 bottom-0 w-40 z-10 bg-gradient-to-l from-white via-white to-transparent"></div>
