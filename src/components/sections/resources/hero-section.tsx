    ...
    <div className="hero-section bg-gradient-to-b from-emerald-50 to-white dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-24 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="hero-text text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
            <span className="block mb-2">Helpful Resources</span>
          ...
          <p className="hero-text mx-auto mt-5 max-w-xl text-xl text-gray-500 dark:text-gray-300">
            Access guides, documentation, and useful materials to help you integrate
            and maximize Bitmopay for your business.
          </p>
