...
export function ResourceLibrary() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 py-24" id="resource-library">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          {resourceCategories.map((resource, index) => (
            <div
              key={index}
              className="resource-card group rounded-xl border border-gray-200 bg-white p-6 
                shadow-sm transition-all duration-200 hover:shadow-md dark:border-gray-700 
                dark:bg-gray-800 hover:border-emerald-200 dark:hover:border-emerald-800"
            >
              <div className="flex flex-col h-full">                <div className="flex items-center justify-between">
                ...
                <h3 className="mt-4 font-semibold text-gray-900 dark:text-white text-xl">
                  {resource.title}
                </h3>
                ...
                <Link
                  href={resource.href}
                  className="mt-5 inline-flex items-center text-emerald-600 hover:text-emerald-800 
                    dark:text-emerald-400 dark:hover:text-emerald-300 font-medium"
                >
                  View resources
