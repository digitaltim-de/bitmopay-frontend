      ...
      >
        ...
        <div className="overflow-hidden p-4 sm:p-6">
          <div className="relative h-48 overflow-hidden rounded-xl sm:h-56 md:h-64">
            ...
            <div
              className="absolute inset-0 bg-gradient-to-t from-white to-transparent opacity-40 transition-opacity
                duration-300 group-hover:opacity-60"
            ></div>
        ...
        <div className="relative z-10 flex flex-grow flex-col p-6 sm:p-8">
          <div className="mb-2">
            ...
            <div
              className="h-1 w-16 origin-left scale-0 transform rounded-full bg-emerald-500 transition-transform duration-300
                ease-out group-hover:scale-100"
            ></div>
          </div>
...
const ImageCard: React.FC<ImageCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        `group relative h-full overflow-hidden rounded-xl shadow-sm transition-all duration-300
        hover:shadow-xl`,
        className,
      )}
    >
    ...
    <Section className="relative" aria-labelledby="start-accepting-title">
      ...
      <div className="relative z-10">
        <div className="mb-4 text-center">
          <Badge>Bitmopay features</Badge>
        </div>

        <div className="w-full text-center">
          <HeadTitle
            title="Start Accepting Crypto Payments"
            subtitle="  Flexible solutions for various business models - from one-time payments to subscriptions"
            htype="h2"
          />
        </div>
