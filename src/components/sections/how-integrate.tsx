  ...
  return (
    <Section className="background-light-gray-2">
      ...
      <div className="relative mb-12">
        <div className="absolute left-0 right-0 top-1/2 h-[1px] -translate-y-1/2 bg-gray-200 dark:bg-gray-700"></div>
      ...
      {/* Content Display */}
      <div className="relative min-h-[400px] overflow-hidden rounded-xl bg-white shadow-sm dark:bg-gray-800">
        <div className="p-8 md:p-10">
          <div className="flex flex-col gap-10 md:flex-row md:items-start">
            {/* Left Content */}
            <div className="md:w-2/5">
              <div className="mb-6 inline-flex items-center justify-center rounded-lg bg-emerald-50 p-4 dark:bg-emerald-900/20">
            ...
            <div className="overflow-hidden rounded-lg bg-gray-50 p-6 shadow-sm dark:bg-gray-900 md:w-3/5">
...
const CryptoVisual = () => (
  <div className="grid h-full grid-cols-3 place-content-center gap-4">
    {["BTC", "ETH", "USDT", "SOL", "USDC", "BNB", "XRP", "ADA", "DOT"].map((coin, i) => (
      <div
        key={i}
        className="flex aspect-square items-center justify-center rounded-lg bg-white shadow-sm dark:bg-gray-800"
      >
        <div
...
const WalletVisual = () => (
  <div className="flex h-full items-center justify-center">
    <div className="w-full max-w-xs rounded-xl bg-white p-4 shadow-sm dark:bg-gray-800">
