...
export function SandboxSection() {
  return (
    <section className="py-20 bg-white border-t">
      <div className="container bg-secondary rounded-xl p-6 grid md:grid-cols-2 gap-12 items-start">
        <div className=" text-gray-900">
          <h2 className="text-4xl font-bold mb-4">Try Bitmopay in seconds</h2>
          <p className="text-muted-foreground mb-6 max-w-lg">
            Experience our API without registration. Just paste your key and
            simulate a crypto payment flow instantly.
          </p>
