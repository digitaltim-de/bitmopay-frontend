      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            <div
              className="mt-4 flex flex-col gap-4 text-sm text-gray-300 dark:text-gray-200 sm:flex-row sm:items-center
                sm:gap-6"
            >
          ...
          <div className="relative h-full w-full rounded-lg delay-300 duration-700 animate-in slide-in-from-right">
            <div className="absolute inset-0 z-10 rounded-lg bg-gradient-to-r from-emerald-900 to-transparent md:hidden"></div>
